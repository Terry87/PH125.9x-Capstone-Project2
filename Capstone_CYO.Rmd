---
title: "PH125.9x Capstone Project - Choose Your Own"
author: "TerryH87"
date: "26 March 2019"
output: pdf_document
---
...
## Introduction
The dataset chosen for this project is _Rain in Australia_, which is a publicly available dataset found on the Kaggle website (see <https://www.kaggle.com/jsphyg/weather-dataset-rattle-package>). The dataset contains daily measurements of various weather variables from weather stations at a number of locations throughout Australia, over a period of several years.  
